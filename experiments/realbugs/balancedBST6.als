...
pred Sorted() {
  all n: Node {
    ...
    -- TODO: Your code starts here.
    all l: n.left.*(left + right) | n.elem > l.elem

    // All elements in the n's right subtree are bigger than the n's elem.
    -- TODO: Your code starts here.
    all r: n.right.*(left + right) | n.elem < r.elem
  }
}
...
pred Balanced() {
  all n1, n2: Node {
    ...
    ((HasAtMostOneChild[n1]) and (HasAtMostOneChild[n2])) => ((Depth[n1] - Depth[n2] < 2) && (Depth[n1] - Depth[n2] > -2))
  }
}
