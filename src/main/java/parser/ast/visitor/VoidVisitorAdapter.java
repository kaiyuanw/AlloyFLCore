...
public class VoidVisitorAdapter<A> implements VoidVisitor<A> {
  ...
  public void visit(ModelUnit n, A arg) {
    ...
    n.getPredDeclList().forEach(predicate -> predicate.accept(this, arg));
  ...
  public void visit(FieldDecl n, A arg) {
    n.getVariables().forEach(variable -> variable.accept(this, arg));
  ...
  public void visit(ListExpr n, A arg) {
    n.getArguments().forEach(expr -> expr.accept(this, arg));
  }
